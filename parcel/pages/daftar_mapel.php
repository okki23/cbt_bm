...
Tambah Mapel</button>
<?php echo "</a>";?>
<a href="?modul=upl_mapel"><button type="button" class="btn btn-info btn-small" ><i class="fa fa-plus-circle"></i> Import Data</button></a>
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td style="text-align:center"><?php echo $s['XPersenUH']; ?></td> 
                                        <td style="text-align:center"><?php echo $s['XPersenUTS']; ?></td>
                                        <td style="text-align:center"><?php echo $s['XPersenUAS']; ?></td>
                                        <td style="text-align:center"><?php echo $s['XKKM']; ?></td>      
                                        <td><?php echo $s['XMapelAgama']; ?></td>                      
										<?php echo "<td style='text-align:center'><a href='#myModal' id='custId' data-toggle='modal' data-id=".$s['Urut'].">"; ?>
