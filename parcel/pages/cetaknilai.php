...
if(isset($_REQUEST['kelas'])){ 
 ...
 /********* Semester 1 ***************/
	...
	XKodeMapel = '$_REQUEST[mapz]' and XSemester = '1' ");
...
if(!$totUH1==""){
 ...
 /********* Semester 2 ***************/
	...
	XKodeMapel = '$_REQUEST[mapz]' and XSemester = '2' ");
	...
	and	XKodeMapel = '$_REQUEST[mapz]' and XSemester = '2' ");
	...
	$uts2 = mysql_query("SELECT sum(XNilai) as totUTS2 FROM cbt_nilai where XNIK = '$d[XNIK]' and XKodeUjian = 'UTS' and XKodeMapel = '$_REQUEST[mapz]' and XSemester = '2' ");
	$tuts2 = mysql_fetch_array($uts2);
	if(isset($tuts2['totUTS2'])){$totUTS2 = number_format($tuts2['totUTS2'], 2, ',', '.');
	$TUTS2 = $tuts2['totUTS2'];
	} else {$totUTS2="";$TUTS2="";}	

	$uas2 = mysql_query("SELECT sum(XNilai) as totUAS2 FROM cbt_nilai where XNIK = '$d[XNIK]' and XKodeUjian = 'UAS' and XKodeMapel = '$_REQUEST[mapz]' and XSemester = '2' ");
