                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <table width="100%"><tr><td><a href="?modul=analisasoal"><button class="btn btn-default">
                            <i class="fa fa-arrow-circle-left"></i> Kembali ke Daftar</button></a> </td><td align="right">
						...
						$nilaiawal = round($o['hasil'],2);
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="center"><a href=?modul=lks&soal=<?php echo $s['XKodeSoal']; ?>&siswa=<?php echo $s['XNomerUjian']; ?>&token=<?php echo $s['XTokenUjian']; ?> data-toggle="tooltip" title="Penilaian Esai">
                                        <button type="button" class="btn btn-info btn-small"><i class="fa fa-file-text-o"></i></button></a>
										<a href=?modul=jawabansiswa&soal=<?php echo $s['XKodeSoal']; ?>&siswa=<?php echo $s['XNomerUjian']; ?>&token=<?php echo $s['XTokenUjian']; ?> data-toggle="tooltip" title="Hasil Nilai Ujian">
                                        <button type="button" class="btn btn-success btn-small"><i class="fa fa-edit"></i></button></a>
										</td>		
