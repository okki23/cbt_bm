...
?>
    ...
    <td rowspan="4" width="150" align="center"><img src="../../images/<?php echo "$logsek"; ?>" width="80"></td>
  ...
  <?php echo "$xkab"; ?> telah diselenggarakan Ujian Berbasis Komputer (UBK) untuk matapelajaran <?php echo $rs2; ?> dari pukul 
