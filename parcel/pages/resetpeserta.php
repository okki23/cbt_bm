                        ...
                        data-row-select="true" data-keep-selection="true">
                            <thead>
                                <tr style="background-color:#e7e7e7">
                                    <th data-column-id="id" data-identifier="true" data-type="varchar" data-align="right" data-width="3%">No.</th>
									...
									<th data-column-id="jurusan" data-css-class="cell" data-header-css-class="column" data-filterable="true" data-width="10%" >Jurusan</th>                                    <th data-column-id="mapel" data-css-class="cell" data-header-css-class="column" data-filterable="true" data-width="14%" >Mapel</th>
