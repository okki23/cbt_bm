...
//alert(txt_mapel);   
 $.ajax({
	 ...
	 txt_jumsoal2 + "&txt_soal=" + txt_soal + "&txt_sesi=" + txt_sesi + "&txt_bobotsoal1=" + txt_bobotsoal1  + "&txt_bobotsoal2=" + txt_bobotsoal2 + "&txt_kodesek=" + txt_kodesek,
	 success: function(data){
		 swal({
  
  type: 'success',
  title: 'Bank Soal Berhasil disimpan',
...
<div id="mainbody" >
                        ...
                        <div class="panel-body">
                            <table width="100%">
                            <tr height="32px"><td>Kode Sekolah&nbsp;</td><td>: 
                            
                            	<select name="txt_kodesek" id="txt_kodesek">
                                <?php 
                                ...
                                ?>
                                </select><tr height="32px"><td width="40%">Nama Bank Soal&nbsp;</td><td>: <input type="text" id="txt_namaz" required/></td></tr>
                        ...
                        <?php 
						 ...
						 ?>
                            ...
                            <tr height="32px"><td width="40%">Opsi Pilihan Jawaban&nbsp;</td><td>
							: <select  id="txt_jawabz"> * Default 5 Pilihan
                        ...
                        <div class="modal-footer">
                            <button type="submit"  class="btn btn-info btn-lg btn-small" id="baru" value="Buat" name="baru">Baru</button>
							 <button type="button" class="btn btn-danger btn-lg btn-small" data-dismiss="modal">Close</button>
                        </div>
