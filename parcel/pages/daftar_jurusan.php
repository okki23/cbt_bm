...
//echo "delete from cbt_jurusan where Urut = '$_REQUEST[urut]'";
$sql = mysql_query("delete from cbt_jurusan where Urut = '$_REQUEST[urut]'");
}


if(isset($_REQUEST['simpan'])){
	$sql = mysql_query("update cbt_jurusan set XJurusan = '$_REQUEST[txt_jur]' where Urut = '$_REQUEST[urut]'");
}

if(isset($_REQUEST['tambah'])){

$sqlcek = mysql_num_rows(mysql_query("select * from cbt_jurusan where XJurusan = '$_REQUEST[txt_jur]'"));
	if($sqlcek>0){
	$message = "Kode Jurusan SUDAH ADA";
	echo "<script type='text/javascript'>alert('$message');</script>";
	} else {
		if(!$_REQUEST['txt_jur']==""){
		$sql = mysql_query("insert into cbt_jurusan (XJurusan, XStatus) values  
		('$_REQUEST[txt_jur]','1')");
		}
	}
}
...
<?php echo "</a>";?>                            
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <?php 
								$sql = mysql_query("select * from cbt_jurusan order by XJurusan");
								$no=1;
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <a href="?modul=daftar_jurusan&aksi=hapus&urut=<?php echo $s['Urut']; ?>"><button type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash-o "></i></button></a></td>                                                                               
                                    </td></tr>
  ...
  <!-- Button trigger modal -->
       ...
       <div class="modal fade" id="myTam" role="dialog">
        ...
        <!-- MEMBUAT FORM -->
        <form action="?modul=daftar_jurusan&tambah=yes" method="post">
