...
$NilaiKKMe = $rs['XKKM'];
   ...
   $this->Cell(13,1,'DAFTAR NILAI UTS '. $namsek. '',0,0,'L',0);
   ...
   $this->Cell(2.0,1,'UTS','LTB',0,'C',1); // cell dengan panjang 2   
...
$sto1 = mysql_query("
SELECT sum(XNilai) as totTO1, count(XNilai) as jujum2 FROM cbt_nilai where  (XKodeKelas = '$_REQUEST[kelz]' or XKodeKelas='ALL') and XNIK = '$f[XNIK]' and XKodeUjian = 'UTS' 
