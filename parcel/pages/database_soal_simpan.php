...
if(str_replace(" ","",$_REQUEST['txt_nama'])!=='')	{
	...
	if($jumcek<1){
		...
		(XKodeMapel,XLevel,XKodeSoal,XJumPilihan,XAcakSoal,XTglBuat,XGuru,XKodeKelas,XKodeJurusan,XJumSoal,XSesi,XPilGanda,XEsai,XPersenPil,XPersenEsai,XKodeSekolah) values 
