...
<html>
<head>
<title>SMK HSA | Cetak Kartu</title>
...
while($f= mysql_fetch_array($cekQuery1)){
	...
	XKodeMapel = '$_REQUEST[map3]' and XSemester = '1' ");
	...
	and	XKodeMapel = '$_REQUEST[map3]' and XSemester = '1' ");
/*$uh = mysql_query("
...
if(!$totUH1==""){
	...
	XKodeMapel = '$_REQUEST[map3]' and XSemester = '2' ");
	...
	and	XKodeMapel = '$_REQUEST[map3]' and XSemester = '2' ");
