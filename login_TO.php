...
<div class="group">
 ...
 <div style="margin-top:0px; bottom:0px; background-color:#dcdcdc; padding:0px; font-size:8px">
    <div class="content hidden-xs">
     <marquee><h4>Jika mengalami kesulitan silakan menghubungi proktor </h4></marquee>
   </div>
</div>
<ul>
...
<div class="panel panel-default" style="margin-top:0px">
            <div class="panel-heading" align="center" style="font-size:20px;  font-weight:bold">
               LOGIN PESERTA TRY OUT 
	       <br>Teknik Komputer & Jaringan
	       <br>Tahun Pelajaran 2021-2022
